...
class PartialParse(object):
    def __init__(self, sentence):
        ...
        elif isinstance(self.sentence, str):
    ...
    def is_terminate(self):
        ...
        return len(self.stack)==1 and len(self.buffer) == 0 and len(self.dependencies) > 0
...
def minibatch_parse(sentences, model, batch_size):
    ...
    while any(unfinished_parses):
        ...
        for parser, t in zip(mini_batch, transitions): 
            parser.parse_step(t)
        unfinished_parses = [parser for parser in unfinished_parses if not parser.is_terminate()]
